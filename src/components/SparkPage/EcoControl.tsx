  ...
  return (
    ...
    >
      ...
      <select
        ...
        className={`rounded border border-border bg-surface-elevated text-[11px] text-text outline-none focus:border-accent disabled:opacity-50 ${
      ...
      <button
        ...
        className={`flex items-center gap-1.5 rounded-md border border-border bg-surface-elevated text-[11px] text-muted transition-colors hover:bg-accent/15 hover:text-accent disabled:opacity-50 ${
